...
exports.defaultTheme = exports.ModalMessage = exports.ModalContainer = exports.ModalButton = void 0;
...
const ModalMessage = _styledComponents.default.div(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  width: 25rem;\n  display: flex;\n  justify-content: space-between;\n  margin: auto;\n  position: -webkit-sticky;\n  position: sticky;\n  top: 40%;\n  background-color: ", ";\n  border: 1rem ridge ", ";\n  border-radius: 2rem;\n  color: white;\n  font-size: 1.3rem;\n  font-weight: bold;\n  padding: 1rem 2rem;\n  &:hover {\n    color: ", ";\n    background-color: ", ";\n  }\n"])), props => props.theme.messageBg, props => props.theme.borderColor, props => props.theme.messageHoverTxt, props => props.theme.messageHoverBg);
